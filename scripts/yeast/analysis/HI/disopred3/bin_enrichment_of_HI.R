...
stopifnot(FALSE)
png(filename = 'figures/yeast/HI/5x5HI.png', width = 2000, height = 950, res = 300)
...
### Visualize
png(filename = 'figures/yeast/HI/5x5HI_p.png', width = 2000, height = 950, res = 300)

pheatmap(mat = p_value_matrix,
         main = paste0("Yeast: Percent Enrichment of Haploinsufficiencyis P Values"),
         breaks = c(0, alpha, 1),
         cluster_cols = FALSE,
         cluster_rows = FALSE,
         color = c('red4', 'grey'),
...
png(filename = 'figures/yeast/HI/HI_p.png', width = 1400, height = 850, res = 300)

color <- brewer.pal(n = 5, name = 'Reds')
color <- rev(append(color, 'black'))
pheatmap(mat = p_value_matrix,
         main = paste0("Yeast: HI Enrichment P Values"),
         cluster_cols = FALSE,
         cluster_rows = FALSE,
         color = color,
         labels_row = '         ',
