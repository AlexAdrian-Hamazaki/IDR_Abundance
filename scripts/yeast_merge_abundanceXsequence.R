...
#We need our linker table generated in collapse_alises.R to combine the two tables
df_pro_linker <- read.delim(file = "data/abundance/df_pro_linker.tsv")
...
write.table(x = yea_abundance,
            file = '../data/merged_tables/yeast_abundanceXsequences.tsv',
            col.names = TRUE,
            quote = FALSE,
            sep = "\t"
)
